...
class ManagePermissions(val activity: Activity,val list: List<String>,val code:Int) {
    ...
    private fun showAlert() {
        ...
        builder.setMessage("This application needs a permissions in order to read and write files")
        builder.setPositiveButton("Give permission", { dialog, which -> requestPermissions() })
